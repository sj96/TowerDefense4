...
public class wizar3 extends Tower{
	Bitmap castWi, Fireball, boom;
	RedyCast cast;
	public wizar3(Bitmap bit,Bitmap cast, Bitmap fireb, Bitmap Boom, float bx, float by,Handler h , Handler EnemyList) {
		super(bit, ID.wizar, bx, by, 16, 2, h, EnemyList);
		this.setInfo(180,  30, 4, ruler*3, 16);
		// hp, at, df, rg, bp
		this.blockCount=0;
		castWi=cast;
		Fireball = fireb;
	...
	public Tower MakeClone() {
		wizar3 ac = new wizar3(bitmap, castWi, Fireball, boom, x, y, handler, enemylist);
		return ac;
	}
