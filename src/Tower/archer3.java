...
public class archer3 extends Tower{
	Bitmap ArrowBItmap;
	public archer3(Bitmap bit, Bitmap ARB, float bx, float by,Handler h , Handler EnemyList) {
		super(bit, ID.archer, bx, by, 7, 2, h, EnemyList);
		this.setInfo(360,  20, 4, ruler*3, 10);
		// hp, at, df, rg, bp
		this.blockCount=0;
		ArrowBItmap=ARB;
		atackimage=6;
	...
	public Tower MakeClone() {
		archer3 ac = new archer3(bitmap, ArrowBItmap, x, y, handler, enemylist);
		return ac;
	}
	...
	public void update() {
		...
		if(time==0 && crImage==6 && block!=null){//tai vi tri anh thu 6
			tancong();
		}
