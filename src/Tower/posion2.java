...
public class posion2 extends Tower{
	Bitmap ArrowBItmap;
	Bitmap EffectBitmap;
	public posion2(Bitmap bit, Bitmap ARB, Bitmap EFF, float bx, float by,Handler h , Handler EnemyList) {
		super(bit, ID.posion, bx, by, 17, 2, h, EnemyList);
		this.setInfo(220,  9, 0, ruler*3, 4);
		// hp, at, df, rg, bp
		this.blockCount=0;
		ArrowBItmap=ARB;
		EffectBitmap=EFF;
	...
	public Tower MakeClone() {
		posion2 ac = new posion2(bitmap, ArrowBItmap, EffectBitmap, x, y, handler, enemylist);
		return ac;
	}
